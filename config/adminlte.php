...
return [
    ...
    */
    ...
    'logo' => '<b>Bely</b>Boutique',
    'logo_img' => 'vendor/adminlte/dist/img/Icono_Logo.ico',
    ...
    */
    ...
    'use_route_url' => false,
    'dashboard_url' => 'personal/',
    'logout_url' => 'personal/logout',
    'login_url' => 'personal/login',
    'register_url' => 'personal/register',
    'password_reset_url' => 'personal/password/reset',
    'password_email_url' => 'personal/password/email',
    'profile_url' => true,
    ...
    'menu' => [
        ...
        [
            ...
            'submenu'     => [
                [
                    'text'        => 'Modalidades',
                    'url'         => 'personal/modalidades',
                    'icon'        => 'fas fa-tags',
                ],
                [
                    'text'        => 'Tipo de Contratos',
                    'url'         => 'personal/tipo-de-contratos',
                    'icon'        => 'fas fa-paste',
                ],
                [
                    'text'        => 'Contratos',
        ...
        [
            ...
            'submenu'     => [
                [
                    'text'        => 'Motivo de Exoneraciones',
                    'url'         => 'personal/motivo-de-exoneraciones',
                    'icon'        => 'fas fa-comment',
                ],
                [
                    'text'        => 'Exoneraciones',
                    'url'         => 'personal/exoneraciones',
                    'icon'        => 'fas fa-calendar-minus',
                ],
            ]
        ],
        ...
        [
            'text'        => 'Ajustes salariales',
            'url'         => '#',
            'icon'        =>  'far fa-clipboard',
            'submenu'     => [
                [
                    'text'        => 'Tipos',
                    'url'         => 'personal/tipo-de-recortes',
                    'icon'        => 'fas fa-tasks',
                ],
                [
                    'text'        => 'Recortes y bonificaciones',
                    'url'         => 'personal/recortes',
                    'icon'        =>  'far fa-clipboard',
                ],
            ]
        ],
        [
            ...
            'submenu'     => [
                ...
                [
                    'text'        => 'Perfil de Emp.',
                    'url'         => 'personal/perfil-de-empleados',
